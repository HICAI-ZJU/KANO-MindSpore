...
from chemprop_ms.features.features_generators import get_available_features_generators
...
def add_predict_args(parser: ArgumentParser):
    ...
    parser.add_argument('--gpu', type=int,
                        choices=list(range(ms.communication.get_group_size())),
...
def modify_predict_args(args: Namespace):
    ...
    args.cuda = ms.context.set_context(device_target="GPU")
    del args.no_cuda
...
def modify_train_args(args: Namespace):
    ...
    args.cuda = ms.context.set_context(device_target="CPU")
    del args.no_cuda
    '''args.cuda = not args.no_cuda and torch.cuda.is_available()
    del args.no_cuda'''
