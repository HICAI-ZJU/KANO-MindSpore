import sys
sys.path.append('E:/kano_mindspore/KANO_mindspore/chemprop_ms/data/')
...
from chemprop_ms.data.scaler_ms import StandardScaler
from chemprop_ms.features.features_generators import get_features_generator
